...
import static org.openstreetmap.josm.plugins.mdbuildings.BuildingsWayValidator.isBuildingWayValid;
...
public class ReplaceBuildingGeometryCommand extends Command implements CommandResultBuilding, CommandWithErrorReason {
     ...
     */
    private void updateGeometry(Way selBuilding, Way nBuilding) throws IllegalArgumentException,
