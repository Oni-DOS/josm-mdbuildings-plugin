...
import org.openstreetmap.josm.plugins.mdbuildings.BuildingsPlugin;
...
public class BuildingsToggleDialog extends ToggleDialog {
    ...
    public BuildingsToggleDialog() {
        super(
            "MD-Buildings V2",
            "mdbuildings",
            tr("Open the {0} window", BuildingsPlugin.getPluginInfo().name),
            Shortcut.registerShortcut(
                BuildingsPlugin.getPluginInfo().name + ":window",
                tr("MD-Buildings window"),
