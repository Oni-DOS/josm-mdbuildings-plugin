...
import org.openstreetmap.josm.plugins.mdbuildings.ImportMode;
...
import org.openstreetmap.josm.plugins.mdbuildings.ToggleDialogProfilesComboBoxModel;
import org.openstreetmap.josm.plugins.mdbuildings.TogleDialogImportModeComboBoxModel;
...
public final class ToggleDialogController {
    ...
    private final class DataSourceProfileComboBoxItemChanged implements ItemListener {
        @Override
    ...
    private final class ImportModeComboBoxItemChanged implements ItemListener {
        @Override
        public void itemStateChanged(ItemEvent itemEvent) {
            if (itemEvent.getStateChange() == ItemEvent.SELECTED) {
    ...
    private final class DataSourceModelChanged implements PropertyChangeListener {
        @Override
